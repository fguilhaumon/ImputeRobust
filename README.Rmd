...
This is a fork where the EXP, GA, LNO, IG, WEI and WEI2 distributions have been included.
...
# Log-transform the first variable
sample.data[, 1] <- log(sample.data[, 1] + 3)
```
